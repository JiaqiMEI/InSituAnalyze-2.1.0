...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.2 on Thu Apr 11 17:03:23 2019
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.textwidth = wx.TextCtrl(self.panel_3, wx.ID_ANY, "15", style=wx.TE_CENTRE)
        self.textorder = wx.TextCtrl(self.panel_3, wx.ID_ANY, "2", style=wx.TE_CENTRE)
        self.textderiv = wx.TextCtrl(self.panel_3, wx.ID_ANY, "0", style=wx.TE_CENTRE)
    ...
    def __do_layout(self):
        ...
        label_1 = wx.StaticText(self.panel_3, wx.ID_ANY, "S-G Derivative")
        ...
        sizer_14.Add((10, 20), 0, wx.ALIGN_CENTER, 0)
        derivA = wx.StaticText(self.panel_3, wx.ID_ANY, "deriv")
        sizer_14.Add(derivA, 0, wx.ALIGN_CENTER | wx.ALL, 5)
        sizer_14.Add(self.textderiv, 0, wx.ALIGN_CENTER | wx.ALL, 5)
        sizer_14.Add((20, 20), 1, wx.ALIGN_CENTER, 0)
    ...
    def ConfirmEve(self, event):  # wxGlade: MyFrame.<event_handler>
        ...
        G.Deriv = float(self.textderiv.GetValue())
